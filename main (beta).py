...
def get_data(all_pages_dict):
    ...
    with open(f"data.csv", "a", encoding="cp1251", newline='') as file:
    ...
    for num_page, page_href in all_pages.items():
        ...
        for item in addresses_table:
            ...
            # print(address_href)
            req_address = get_request('https://dom.mingkh.ru' + address_href)
